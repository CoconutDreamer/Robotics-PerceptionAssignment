...
h1 = H1*(f_ref/(f_ref+d1_ref))


mid = 1 - h1/ratio*H2


%f = h1*d2_ref*f_ref/(ratio*H2*mid)

%deltaZ = d2_ref + f_ref/100


%r = (d1_ref/d2_ref)*ratio

%f = ((d2_ref-d1_ref)*(f_ref))/((r*d2_ref)-d1_ref)

%pos = (d1_ref*d2_ref*(1-r))/(d1_ref-(r*d2_ref))
